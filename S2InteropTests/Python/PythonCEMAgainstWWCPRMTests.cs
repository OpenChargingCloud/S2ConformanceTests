    ...
    public sealed class PythonCEMAgainstWWCPRMTests
    {
        ...
        private sealed class RMFixture : IAsyncDisposable
        {
                                                  ...
                                                  IReadOnlyList<String>?  SupportedVersions   = null)
            {
                ...
                // A short request timeout (Hermod's default is 10 minutes) and the log of the
                // WWCP S2 and Hermod side in the test output: the response log below shows what
                // went wrong when an upgrade fails.
